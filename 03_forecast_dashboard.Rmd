...
fcast_tbbl <- read_rds(here("temp","fcast_tbbl.rds"))%>%
  ...
  mutate(prop_reg_utilized=round(prop_reg_utilized, 3),
         across(c(new_reg,
            employment,
            demand_driven_fcast,
            obs_and_fcast,
...
*   **Prop Reg Utilized** is $\frac{\sum \mbox{new registration}}{\sum \mbox{employment}}$ for the years 2016, 2017, 2018, 2019, 2021, 2022.
