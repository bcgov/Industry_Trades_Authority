...
fcast_tbbl <- read_csv(here("temp","fcast_tbbl.csv"))%>%
...
for_plots <- read_csv(here("temp","for_plots.csv"))%>%
...
*   **Adjusted Forecast** adds half of the **Gap** to the years 2022 and 2023.
