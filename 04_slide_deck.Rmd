---
title: \textcolor{black}{New Apprenticeship Registrations and Apprenticeship Certifications for}
subtitle: \textcolor{black}{`r format(readRDS(here::here("temp","max_date.rds")), format="%B %Y")`}
